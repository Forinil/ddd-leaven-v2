...
@FinderImpl
class JpaOfferFinder : Offer {

    @PersistenceContext
    private val entityManager: EntityManager? = null

    override fun find(query: OfferQuery): List<OfferedProductDto> {
        val bestBeforeExpired = query.isBestBeforeExpired
        ...
        return entityManager!!
                ...
                .resultList.toList() as List<OfferedProductDto>
    }
