...
class PaymentFactory {
    ...
    @Inject
    private val publisher: DomainEventPublisher? = null

    fun createPayment(clientData: ClientData, amount: Money): Payment {
        //TODO validate

        val aggregateId = AggregateId.generate()
        publisher!!.publish(ClientPaidEvent(aggregateId, clientData, amount))
        return Payment(aggregateId, clientData, amount)
    }
}
