 ...
 */
class SimilarName(private val name: String) : CompositeSpecification<Product>() {

    override fun isSatisfiedBy(candidate: Product): Boolean {
        return candidate.name.contains(name) || candidate.productType.toString().contains(name)
    }
