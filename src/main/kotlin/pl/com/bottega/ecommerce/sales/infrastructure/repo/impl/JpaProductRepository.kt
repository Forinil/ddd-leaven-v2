...
class JpaProductRepository : GenericJpaRepository<Product>(), ProductRepository {

    override fun findProductWhereBestBeforeExpiredIn(days: Int): List<Product> {
        //TODO take days into consideration
        return entityManager!!.createQuery("FROM Product p").resultList.toList() as List<Product>
    }
