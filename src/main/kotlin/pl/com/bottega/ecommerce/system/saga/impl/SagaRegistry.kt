...
interface SagaRegistry {
    ...
    fun getLoadersForEvent(event: Any): Collection<SagaManager<SagaInstance<Any>, *>>

    fun <T> createSagaInstance(sagaType: Class<out SagaInstance<*>>, sagaData: T): SagaInstance<T>
}
