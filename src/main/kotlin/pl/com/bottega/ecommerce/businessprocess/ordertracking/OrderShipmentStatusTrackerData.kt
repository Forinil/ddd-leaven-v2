...
@Entity
class OrderShipmentStatusTrackerData {
    ...
    var orderId: AggregateId? = null

    /**
     * Id of shipment aggregate (from shipment module) once it's created.
     */
    @AttributeOverrides(AttributeOverride(name = "aggregateId", column = Column(name = "shipmentId")))
    var shipmentId: AggregateId? = null

    var shipmentReceived: Boolean? = false
}
